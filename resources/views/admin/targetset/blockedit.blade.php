                                                                                ...
                                                                                <table class="table-bordered" style="width:100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <span class="text-success">{{ empty($targetdistrict->gen_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targetdistrict->gen_target, 2) }}</span>
                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_gen_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_gen_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_sc_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_sc_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_st_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_st_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_women_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_women_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-10">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-6">
                                                                                            ...
                                                                                            <input type="hidden" name="old_private_gen_target[]" value="{{ empty($targettehsil->assigned_private_gen_target)?'0.00': $targettehsil->assigned_private_gen_target }}"/>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="hidden" name="old_private_sc_target[]" value="{{ empty($targettehsil->assigned_private_sc_target)?'0.00': $targettehsil->assigned_private_sc_target }}"/>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="hidden" name="old_private_st_target[]" value="{{ empty($targettehsil->assigned_private_st_target)?'0.00': $targettehsil->assigned_private_st_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_st_target[]" @if(empty($targettehsil->assigned_private_st_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->private_st_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_private_st_target)?'0.00': $targettehsil->assigned_private_st_target }}" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            <span class="text-success">{{ empty($targetdistrict->private_women_target)?'0.00': $targetdistrict->private_women_target }}</span>
                                                                                        <input type="hidden" name="old_private_women_target[]" value="{{ empty($targettehsil->assigned_private_women_target)?'0.00': $targettehsil->assigned_private_women_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_women_target[]" @if(empty($targettehsil->assigned_private_women_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->private_women_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_private_women_target)?'0.00': $targettehsil->assigned_private_women_target }}" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_private_gen_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_private_gen_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_private_sc_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_private_sc_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_private_st_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_private_st_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->assigned_private_women_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->assigned_private_women_target, 2) }}" readonly="readonly" />
                                                                                        </td>
                                                                                        <td class="w-15">
