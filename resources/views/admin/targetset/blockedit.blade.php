                                                                                ...
                                                                                <table class="table-bordered" style="width:100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" name="gen_target[]" @if(empty($targetdistrict->gen_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->gen_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_gen_target)?'0.00': $targettehsil->assigned_gen_target }}" onChange="return getgenvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="hidden" name="old_sc_target[]" value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="sc_target[]" @if(empty($targetdistrict->sc_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->sc_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_sc_target)?'0.00': $targettehsil->assigned_sc_target }}" onChange="return getscvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="hidden" name="old_st_target[]" value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="st_target[]" @if(empty($targetdistrict->st_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->st_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_st_target)?'0.00': $targettehsil->assigned_st_target }}" onChange="return getstvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <input type="hidden" name="old_women_target[]" value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="women_target[]" @if(empty($targetdistrict->women_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->women_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_women_target)?'0.00': $targettehsil->assigned_women_target }}" onChange="return getwomenvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_st_target[]" @if(empty($targettehsil->private_st_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->private_st_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->assigned_private_st_target)?'0.00': $targettehsil->assigned_private_st_target }}" onChange="return getprivatestvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            {{ (!empty($targetdistrict->assigned_physical_target) ? (number_format($targetsset->physical_target, 2)-number_format((isset($alltargetdistrict->public)?$alltargetdistrict->public:0), 2)) : 0.00) }}  / {{ number_format($targetsset->physical_target, 2) }}                                                                                                
                                                                                                        ...
                                                                                                        <input type="hidden" name="target_tehsil_id[]" value="{{!empty($targettehsil->id)?$targettehsil->id:''}}"/>                                                                                           
                                                                                                            ...
                                                                                                            <input type="hidden" name="old_gen_target[]" value="{{ empty($targetdistrict->gen_target)?'0.00': $targetdistrict->gen_target }}"/>
                                                                                                            <span class="text-success">{{ empty($targetdistrict->gen_target)?'0.00': $targetdistrict->gen_target }}</span>
                                                                                                            <input type="text" maxlength="9" class="w-80" name="gen_target[]" @if(empty($targetdistrict->gen_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->gen_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->gen_target)?'0.00': $targettehsil->gen_target }}" onChange="return getgenvalues(this);"/>
                                                                                                        </td>
                                                                                                        <td class="w-8">
                                                                                                        <span class="text-success">{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}</span>
                                                                                                        <input type="hidden" name="old_sc_target[]" value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}"/>
                                                                                                            <input type="text" maxlength="9" class="w-80" name="sc_target[]" @if(empty($targetdistrict->sc_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->sc_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->sc_target)?'0.00': $targettehsil->sc_target }}" onChange="return getscvalues(this);"/>
                                                                                                        </td>
                                                                                                        <td class="w-8">
                                                                                                        <span class="text-success">{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}</span>
                                                                                                        <input type="hidden" name="old_st_target[]" value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}"/>
                                                                                                            <input type="text" maxlength="9" class="w-80" name="st_target[]" @if(empty($targetdistrict->st_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->st_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->st_target)?'0.00': $targettehsil->st_target }}" onChange="return getstvalues(this);"/>
                                                                                                        </td>
                                                                                                        <td class="w-8">
                                                                                                        <span class="text-success">{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}</span>
                                                                                                        <input type="hidden" name="old_women_target[]" value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}"/>
                                                                                                            <input type="text" maxlength="9" class="w-80" name="women_target[]" @if(empty($targetdistrict->women_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->women_target)) readonly="readonly" @endif @endif value="{{ empty($targettehsil->women_target)?'0.00': $targettehsil->women_target }}" onChange="return getwomenvalues(this);"/>
                                                                                                        </td>
                                                                                                        <td class="w-8">
                                                                                                        <span class="text-success">{{ empty($targetdistrict->gen_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targetdistrict->gen_target, 2) }}</span>
                                                                                                            <input type="text" class="w-80" value="{{ empty($targettehsil->gen_target)? '0.00': number_format((float)$scheme['cost_norms']*(float)$targettehsil->gen_target, 2) }}" readonly="readonly" />
