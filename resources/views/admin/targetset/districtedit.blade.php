                                                                                ...
                                                                                <table class="table-bordered" style="width:100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-8">                                                                                            
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" name="gen_target[]" @if(empty($targetdistrict->gen_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->gen_target)) readonly="readonly" @endif @endif value="{{ empty($targetdistrict->gen_target)?'0.00': $targetdistrict->gen_target }}" onChange="return getgenvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_sc_target[]" value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="sc_target[]" @if(empty($targetdistrict->sc_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->sc_target)) readonly="readonly" @endif @endif value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}" onChange="return getscvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_st_target[]" value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="st_target[]" @if(empty($targetdistrict->st_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->st_target)) readonly="readonly" @endif @endif value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}" onChange="return getstvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_women_target[]" value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="women_target[]" @if(empty($targetdistrict->women_target)) readonly="readonly" @else @if(empty((float)$targetdistrict->women_target)) readonly="readonly" @endif @endif value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}" onChange="return getwomenvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-6">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="private_gen_target[]" name="private_gen_target[]" @if(empty($targetdistrict->private_gen_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_gen_target)?'0.00': $targetdistrict->private_gen_target }}" onChange="return getprivategenvalues(this);"/>
                                                                                        </td>
                                                                                        ...
                                                                                        <input type="hidden" name="old_private_sc_target[]" value="{{ empty($targetdistrict->private_sc_target)?'0.00': $targetdistrict->private_sc_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_sc_target[]" @if(empty($targetdistrict->private_sc_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_sc_target)?'0.00': $targetdistrict->private_sc_target }}" onChange="return getprivatescvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_private_st_target[]" value="{{ empty($targetdistrict->private_st_target)?'0.00': $targetdistrict->private_st_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_st_target[]" @if(empty($targetdistrict->private_st_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_st_target)?'0.00': $targetdistrict->private_st_target }}" onChange="return getprivatestvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_private_women_target[]" value="{{ empty($targetdistrict->private_women_target)?'0.00': $targetdistrict->private_women_target }}"/>
                                                                                            <input type="text" maxlength="9" class="w-80" name="private_women_target[]" @if(empty($targetdistrict->private_women_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_women_target)?'0.00': $targetdistrict->private_women_target }}" onChange="return getprivatewomenvalues(this);"/>
                                                                                        </td>
                                                                                        <td class="w-8">
