                                                                                ...
                                                                                <table class="table-bordered" style="width:100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-8">                                                                                            
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="gen_target[]" name="gen_target[]" @if(empty($targetdistrict->gen_target) && empty((int)$targetsset->physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->gen_target)?'0.00': $targetdistrict->gen_target }}" />
                                                                                            
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_sc_target[]" value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}"/>
                                                                                        <input type="text" maxlength="9" class="w-80" id="sc_target[]" name="sc_target[]" @if(empty($targetdistrict->sc_target) && empty((int)$targetsset->physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}" />
                                                                                        
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_st_target[]" value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}"/>
                                                                                        <input type="text" maxlength="9" class="w-80" id="st_target[]" name="st_target[]" @if(empty($targetdistrict->st_target) && empty((int)$targetsset->physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->st_target }}" />
                                                                                        
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        <input type="hidden" name="old_women_target[]" value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}"/>
                                                                                        <input type="text" maxlength="9" class="w-80" id="women_target[]" name="women_target[]" @if(empty($targetdistrict->women_target) && empty((int)$targetsset->physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}" />
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-6">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="private_gen_target[]" name="private_gen_target[]" @if(empty($targetdistrict->private_gen_target) && empty((int)$targetsset->private_physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_gen_target)?'0.00': $targetdistrict->private_gen_target }}" />
                                                                                        </td>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="private_sc_target[]" name="private_sc_target[]" @if(empty($targetdistrict->private_sc_target) && empty((int)$targetsset->private_physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_sc_target)?'0.00': $targetdistrict->private_sc_target }}" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="private_st_target[]" name="private_st_target[]" @if(empty($targetdistrict->private_st_target) && empty((int)$targetsset->private_physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_st_target)?'0.00': $targetdistrict->private_st_target }}" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" id="private_women_target[]" name="private_women_target[]" @if(empty($targetdistrict->private_women_target) && empty((int)$targetsset->private_physical_target)) readonly="readonly" @endif value="{{ empty($targetdistrict->private_women_target)?'0.00': $targetdistrict->private_women_target }}" />
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                        ...
                                                                                        <td>
                                                                                            <table class="table-bordered" style="width:100%">
                                                                                                ...
                                                                                                @else
                                                                                                    ...
                                                                                                    @endif
                                                                                                    <!-- if only private sector present -->
                                                                                                    @if(!empty($scheme['private_range']) && empty($scheme['public_range']))
                                                                                                    <tr>
                                                                                                        <td class="w-18">
                                                                                                            Private Sector
                                                                                                        </td>
