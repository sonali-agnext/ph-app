                                                                                ...
                                                                                <table class="table-bordered" style="width:100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="w-8">
                                                                                            ...
                                                                                            <input type="text" maxlength="9" class="w-80" name="gen_target[]" @if(empty($targetdistrict->gen_target)) disabled @else @if(empty((float)$targetdistrict->gen_target)) disabled @endif @endif value="{{ empty($targetdistrict->gen_target)?'0.00': $targetdistrict->gen_target }}"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            <input type="text" maxlength="9" class="w-80" name="sc_target[]" @if(empty($targetdistrict->sc_target)) disabled @else @if(empty((float)$targetdistrict->sc_target)) disabled @endif @endif value="{{ empty($targetdistrict->sc_target)?'0.00': $targetdistrict->sc_target }}"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            <input type="text" maxlength="9" class="w-80" name="st_target[]" @if(empty($targetdistrict->st_target)) disabled @else @if(empty((float)$targetdistrict->st_target)) disabled @endif @endif value="{{ empty($targetdistrict->st_target)?'0.00': $targetdistrict->st_target }}"/>
                                                                                        </td>
                                                                                        <td class="w-8">
                                                                                            <input type="text" maxlength="9" class="w-80" name="women_target[]" @if(empty($targetdistrict->women_target)) disabled @else @if(empty((float)$targetdistrict->women_target)) disabled @endif @endif value="{{ empty($targetdistrict->women_target)?'0.00': $targetdistrict->women_target }}"/>
                                                                                        </td>
                                                                                        <td class="w-8">
