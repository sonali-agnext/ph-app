...
<section class="section dashboard">
    ...
    @endphp
        ...
        <div class="col-lg-12">  
             <div class="card">
                <div class="card-body">  
                <h5 class="card-title">List of Block Officers @if($role_id == 1)<a href="{{route('add-tehsil-officer')}}" role="button" class="btn btn-success btn-sm btn-add">Add</a>@endif</h5>                  
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="#" role="button" data-bs-toggle="modal" data-bs-target="#viewModal{{($key+1)}}"><i class="bi bi-eye-fill"></i></a> @if($role_id == 1)<a href="{{route('edit-tehsil-officer',['id' => $state->id])}}"><i class="bi bi-pencil-square"></i></a> <a href="#" class="delete" data-id="{{$state->id}}"><i class="bi bi-trash-fill"></i></a>@endif</td>
                            </tr>
                            <!-- Modal -->
