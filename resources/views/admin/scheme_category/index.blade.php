...
<section class="section dashboard">
    <div class="row">
        ...
        <div class="col-lg-12">  
             <div class="card">
                <div class="card-body">
                    <h5 class="card-title">List of Scheme Category <a href="{{route('add-scheme-category')}}" role="button" class="btn btn-success btn-sm btn-add">Add</a></h5>
                    <div class="table-responsive">
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>Sr No</th>
                                <th>Parent Scheme Category Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="#" role="button" data-bs-toggle="modal" data-bs-target="#viewModal{{($key+1)}}"><i class="bi bi-eye-fill"></i></a> <a href="{{route('edit-scheme-category',['id' => $scheme_category->id])}}"><i class="bi bi-pencil-square"></i></a> <a href="#" class="delete" data-id="{{$scheme_category->id}}"><i class="bi bi-trash-fill"></i></a></td>
                            </tr>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6"><b>Parent Scheme Category Name</b></div>
        ...
        $('.delete').on('click', function(){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    var saveData = $.ajax({
                        type: 'POST',
                        url: "{{route('delete-scheme-category')}}",
                        data: {'id':id},
                        dataType: "json",
