...
<div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{url('/manage-scheme-category')}}">Manage Scheme Category</li>
    </ol>
...
<section class="section dashboard">
    <div class="row">
        ...
        <div class="col-lg-12">  
             <div class="card">
                <div class="card-body">
                        <h5 class="card-title">Edit Scheme Category</h5>
                            ...
                            <form class="row g-3" method="POST" action="{{ route('update-scheme-category',['id' => $scheme_sub_category->id]) }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" name="subcategory_name" required class="form-control" id="subcategory_name" placeholder="Enter Scheme Category" value="{{$scheme_sub_category->category_name}}">
