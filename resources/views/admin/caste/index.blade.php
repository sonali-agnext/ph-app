...
<section class="section dashboard">
    <div class="row">
        ...
        <div class="col-lg-12">  
             <div class="card">
                <div class="card-body">
                    <h5 class="card-title">List of Caste Categories <a href="{{route('add-caste-category')}}" role="button" class="btn btn-success btn-sm btn-add">Add</a></h5>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="viewModalLabel">View Caste Category</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6"><b>Caste ID</b></div>
                                                <div class="col-md-6"><p>{{ $caste->id}}</p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6"><b>Caste Name</b></div>
                                                <div class="col-md-6"><p>{{ $caste->caste_name}}</p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6"><b>Created</b></div>
                                                <div class="col-md-6"><p>{{ $caste->created_at}}</p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6"><b>Updated</b></div>
                                                <div class="col-md-6"><p>{{ $caste->updated_at}}</p></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $('.delete').on('click', function(){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    var saveData = $.ajax({
                        type: 'POST',
                        url: "{{route('delete-caste-category')}}",
                        data: {'id':id},
                        dataType: "json",
