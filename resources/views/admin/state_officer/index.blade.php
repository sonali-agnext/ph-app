...
<div class="pagetitle">
    <h1>Manage State Officer</h1>
    <nav>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
        <li class="breadcrumb-item active">Manage State Officer</li>
    </ol>
    </nav>
</div><!-- End Page Title -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6"><b>State ID</b></div>
                                                <div class="col-md-6"><p>{{ $state->id}}</p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6"><b>State Name</b></div>
